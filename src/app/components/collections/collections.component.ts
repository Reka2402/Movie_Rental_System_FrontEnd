      ...
      items: [
        {
          ...
          review: 4.8,
          availableCopies: 50,
          description: 'The Avengers assemble to reverse the damage caused by Thanos in the epic finale.',
          director: 'Anthony and Joe Russo',
          rating: 4.8,
          price: 19.99,
          cast: [{ id: 1, name: 'Robert Downey Jr.' }, { id: 2, name: 'Chris Evans' }],
          images: ['/movies/end-game.jpg'],
        },
        {
          id: 2,
          name: 'Wanda',
